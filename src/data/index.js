...
export const TIMELINE = [
  {
    ...
    description: "Your journey begins — registration is open, seats are limited.",
    phase: "PHASE_01",
    status: "active",
  },
  {
    ...
    date: "OCT 10 · 2:00 PM",
    description: "The 24-hour build sprint begins.",
    phase: "PHASE_02",
    status: "upcoming",
  },
  {
    id: 3,
    label: "MENTORING SESSION 01",
    date: "OCT 10 · 5:30 PM",
    description: "Teams receive guidance from mentors.",
    phase: "PHASE_03",
    status: "upcoming",
  },
  {
    id: 4,
    label: "MENTORING SESSION 02",
    date: "OCT 10 · 9:00 PM",
    description: "A second round of expert guidance.",
    phase: "PHASE_04",
    status: "upcoming",
  },
  {
    ...
    date: "OCT 10 · 11:00 PM",
    description: "The overnight build begins.",
    phase: "PHASE_05",
    status: "upcoming",
  },
  {
    id: 6,
    label: "ELIMINATION ROUND 01",
    date: "OCT 11 · 2:00 AM",
    description: "The first judging round begins.",
    phase: "PHASE_06",
    status: "upcoming",
  },
  {
    id: 7,
    label: "ROUND 01 RESULTS",
    date: "OCT 11 · 6:00 AM",
    description: "The first elimination results are announced.",
    phase: "PHASE_07",
    status: "upcoming",
  },
  {
    id: 8,
    label: "ELIMINATION ROUND 02",
    date: "OCT 11 · 10:30 AM",
    description: "The second judging round begins.",
    phase: "PHASE_08",
    status: "upcoming",
  },
  {
    ...
    date: "OCT 11 · 2:00 PM",
    description: "Final teams present their solutions.",
    phase: "PHASE_09",
    status: "upcoming",
  },
  {
    ...
    date: "OCT 11 · 4:30 PM",
    description: "HACK2PITCH 2026 concludes.",
    phase: "PHASE_10",
    status: "upcoming",
  },
];
